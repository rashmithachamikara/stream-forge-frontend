  ...
  useEffect(() => {
    ...
    const fetchInitialData = async () => {
      try {
        ...
        console.error('Failed to load initial viewer dashboard data:', error);
      }
    };
    ...
    <DashboardLayout title="Watch Videos" requiredRoles={['admin', 'editor', 'viewer']}>
      <div className="space-y-8">
        ...
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight">Explore Videos</h1>
        </div>
        ...
        <div className="space-y-6">
          ...
          <VideoFeed
            filters={feedFilters}
            emptyStateMessage="No matching videos found on this channel."
          />
        </div>
      </div>
    </DashboardLayout>
